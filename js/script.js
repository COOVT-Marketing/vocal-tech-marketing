...
// Hand-coded and maintained by our in-house team, not generated by an AI tool.
...
(function () {
  ...
  // services mega-menu (desktop hover, touch/keyboard tap-to-open)
  ...
  if (servicesItem && servicesTrigger && servicesDropdown) {
    ...
    servicesTrigger.addEventListener('click', function (e) {
      // touch/keyboard: first activation opens the panel instead of navigating away
  ...
  // highlight whichever service page (or nav item) matches the current URL
