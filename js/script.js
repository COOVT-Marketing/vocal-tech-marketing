// Vocal Tech Marketing - shared site JS
// theme, mobile nav, scroll reveal, counters, contact form, dropdowns
(function () {
  'use strict';
  ...
  // hero canvas particles (only if present)
  ...
  // contact form (optimistic, posts to Apps Script)
