document.addEventListener("DOMContentLoaded", () => {
    ...
    <div class="nav-inner">
        ...
        <button class="hamburger" id="hamburger" aria-label="Toggle menu" onclick="document.getElementById('navOverlay').classList.add('open')">
...
function initializeSiteEngine() {
    ...
    closeNav?.addEventListener("click", () => navOverlay?.classList.remove("open"));
